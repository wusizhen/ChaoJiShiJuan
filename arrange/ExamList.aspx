...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnEdit" runat="server" CssClass="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cut'"
                                CommandArgument='<%#Eval("id") %>' OnClick="lbtnEdit_Click">编辑考试</asp:LinkButton>
                                <asp:LinkButton ID="lbtnControl" runat="server" CssClass="easyui-linkbutton" data-options="plain:true,iconCls:'icon-redo'"
    ...
    <div id="oe_iframe" class="easyui-window" style="padding: 5px;">
        <iframe src="ExamAdd.aspx" frameborder="0" scrolling="auto" width="100%" height="100%">
        </iframe>
    </div>
