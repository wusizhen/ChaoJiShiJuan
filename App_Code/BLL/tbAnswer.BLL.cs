...
namespace BLL {
	 	//tbAnswer
		public partial class tbAnswerBLL
	{
   		     
		private readonly DAL.tbAnswerDAL dal=new DAL.tbAnswerDAL();
		public tbAnswerBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.tbAnswer GetModelByCache(int id)
		{
			
			string CacheKey = "tbAnswerModel-" + id;
			...
			return (Model.tbAnswer)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbAnswer> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbAnswer> DataTableToList(DataTable dt)
		{
			List<Model.tbAnswer> modelList = new List<Model.tbAnswer>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.tbAnswer model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Model.tbAnswer();					
