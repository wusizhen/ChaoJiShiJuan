...
namespace BLL {
	 	//tbBlank
		public partial class tbBlankBLL
	{
   		     
		private readonly DAL.tbBlankDAL dal=new DAL.tbBlankDAL();
		public tbBlankBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.tbBlank GetModelByCache(int id)
		{
			
			string CacheKey = "tbBlankModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbBlank> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbBlank> DataTableToList(DataTable dt)
		{
			List<Model.tbBlank> modelList = new List<Model.tbBlank>();
			...
			if (rowsCount > 0)
			{
																																...
																																if(dt.Rows[n]["questype"].ToString()!="")
				{
					model.questype=int.Parse(dt.Rows[n]["questype"].ToString());
																																...
																																if(dt.Rows[n]["blanklength"].ToString()!="")
				{
					model.blanklength=int.Parse(dt.Rows[n]["blanklength"].ToString());
				}
