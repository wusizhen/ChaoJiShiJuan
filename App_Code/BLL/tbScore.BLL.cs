...
namespace BLL {
	 	//tbScore
		public partial class tbScoreBLL
	{
   		     
		private readonly DAL.tbScoreDAL dal=new DAL.tbScoreDAL();
		public tbScoreBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.tbScore GetModelByCache(int id)
		{
			
			string CacheKey = "tbScoreModel-" + id;
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbScore> GetModelList(string strWhere)
		{
