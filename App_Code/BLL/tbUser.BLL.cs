...
namespace BLL {
	 	//tbUser
		public partial class tbUserBLL
	{
   		     
		private readonly DAL.tbUserDAL dal=new DAL.tbUserDAL();
		public tbUserBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.tbUser GetModelByCache(int id)
		{
			
			string CacheKey = "tbUserModel-" + id;
