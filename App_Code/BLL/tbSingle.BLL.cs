...
namespace BLL {
	 	//tbSingle
		public partial class tbSingleBLL
	{
   		     
		private readonly DAL.tbSingleDAL dal=new DAL.tbSingleDAL();
		public tbSingleBLL()
		{}
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Model.tbSingle GetModelByCache(int id)
		{
			
			string CacheKey = "tbSingleModel-" + id;
			...
			return (Model.tbSingle)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbSingle> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Model.tbSingle> DataTableToList(DataTable dt)
		{
			List<Model.tbSingle> modelList = new List<Model.tbSingle>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Model.tbSingle model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Model.tbSingle();					
