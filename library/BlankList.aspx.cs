...
public partial class subject_SubjectList : BasePage
{
    ...
    {
        pageTotal = MyUtil.GetCount("tbBlank,tbChapter,tbSubject", "tbBlank.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql());
        gvwData.DataSource = MyUtil.GetListByIndex(pageSize, pageIndex, "tbBlank.*,tbSubject.subjectname,tbChapter.chaptername", "tbBlank,tbChapter,tbSubject", "tbBlank.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql(), "subjectname,tbChapter.chapterno");
