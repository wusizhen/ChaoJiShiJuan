...
public partial class subject_SubjectList : BasePage
{
    ...
    {
        pageTotal = MyUtil.GetCount("tbCheck,tbChapter,tbSubject", "tbCheck.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql());
        gvwData.DataSource = MyUtil.GetListByIndex(pageSize, pageIndex, "tbCheck.*,tbSubject.subjectname,tbChapter.chaptername", "tbCheck,tbChapter,tbSubject", "tbCheck.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql(), "subjectname,tbChapter.chapterno");
