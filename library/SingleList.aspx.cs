...
public partial class subject_SubjectList : BasePage
{
    ...
    {
        pageTotal = MyUtil.GetCount("tbSingle,tbChapter,tbSubject", "tbSingle.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql());
        gvwData.DataSource = MyUtil.GetListByIndex(pageSize, pageIndex, "tbSingle.*,tbSubject.subjectname,tbChapter.chaptername", "tbSingle,tbChapter,tbSubject", "tbSingle.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql(), "subjectname,tbChapter.chapterno");
