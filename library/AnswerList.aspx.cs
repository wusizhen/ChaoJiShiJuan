...
public partial class subject_SubjectList : BasePage
{
    ...
    {
        pageTotal = MyUtil.GetCount("tbAnswer,tbChapter,tbSubject", "tbAnswer.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql());
        gvwData.DataSource = MyUtil.GetListByIndex(pageSize, pageIndex, "tbAnswer.*,tbSubject.subjectname,tbChapter.chaptername", "tbAnswer,tbChapter,tbSubject", "tbAnswer.chapterid=tbChapter.id and tbChapter.subjectid=tbSubject.id", GetWhereSql(), "subjectname,tbChapter.chapterno");
